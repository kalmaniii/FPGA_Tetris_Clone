...
##PUSH BUTTONS
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { i_button[0] }];
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { i_button[1] }];
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { i_button[2] }];
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { i_button[3] }];
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { i_button[4] }];



## RGB LED 1 
set_property -dict {PACKAGE_PIN  N15   IOSTANDARD LVCMOS33 } [get_ports { rl1 }];
set_property -dict {PACKAGE_PIN  M16   IOSTANDARD LVCMOS33 } [get_ports { gl1 }];
set_property -dict {PACKAGE_PIN  R12   IOSTANDARD LVCMOS33 } [get_ports { bl1 }];

## RGB LED 2
set_property -dict {PACKAGE_PIN  N16   IOSTANDARD LVCMOS33 } [get_ports { rl2 }];
set_property -dict {PACKAGE_PIN  R11   IOSTANDARD LVCMOS33 } [get_ports { gl2 }];
set_property -dict {PACKAGE_PIN  G14   IOSTANDARD LVCMOS33 } [get_ports { bl2 }];

## VGA interface

# red 
set_property -dict {PACKAGE_PIN  A3   IOSTANDARD LVCMOS33 } [get_ports { RED0 }];
set_property -dict {PACKAGE_PIN  B4   IOSTANDARD LVCMOS33 } [get_ports { RED1 }];
set_property -dict {PACKAGE_PIN  C5   IOSTANDARD LVCMOS33 } [get_ports { RED2 }];
set_property -dict {PACKAGE_PIN  A4   IOSTANDARD LVCMOS33 } [get_ports { RED3 }];

# green 
set_property -dict {PACKAGE_PIN  C6   IOSTANDARD LVCMOS33 } [get_ports { GREEN0 }];
set_property -dict {PACKAGE_PIN  A5   IOSTANDARD LVCMOS33 } [get_ports { GREEN1 }];
set_property -dict {PACKAGE_PIN  B6   IOSTANDARD LVCMOS33 } [get_ports { GREEN2 }];
set_property -dict {PACKAGE_PIN  A6   IOSTANDARD LVCMOS33 } [get_ports { GREEN3 }];

# blue
set_property -dict {PACKAGE_PIN  B7   IOSTANDARD LVCMOS33 } [get_ports { BLUE0 }];
set_property -dict {PACKAGE_PIN  C7   IOSTANDARD LVCMOS33 } [get_ports { BLUE1 }];
set_property -dict {PACKAGE_PIN  D7   IOSTANDARD LVCMOS33 } [get_ports { BLUE2 }];
set_property -dict {PACKAGE_PIN  D8   IOSTANDARD LVCMOS33 } [get_ports { BLUE3 }];
...
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { scan_done }]; 